...
const Stadistics = (props) => {
  ...
  return (
    <div>
      <Stadistic value={props.good} text={props.textGood} />
      <Stadistic value={props.neutral} text={props.textNeutra} />
      <Stadistic value={props.bad} text={props.textBad} />
      <Stadistic value={props.allComments} text={props.textAll} />
      <Stadistic value={props.commentAvegage} text={props.textAverage} />
      <Stadistic value={props.positivePercent} text={props.textPoitive} />
    </div>
  )
}
